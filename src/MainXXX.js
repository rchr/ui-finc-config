      ...
      GET: {
        params: {
          query: makeQueryFunction(
            'cql.allRecords=1',
            // define the columns, in which the searchterm should be found
            '(label="%{query.query}*" or vendor="%{query.query}*" or platform="%{query.query}*")',
            {
              'Provider Name': 'label',
              'Vendor': 'vendor',
              'Platform': 'platform',
  ...
  render() {
    ...
    return (
      <SearchAndSort
        ...
        // ordering of the column-order (headline and content)
        ...
        columnMapping={{
          // translations for column-headlines
          name: 'ui-erm-usage.providerName',
          vendor: 'ui-erm-usage.vendor',
          platform: 'ui-erm-usage.platform',
          harvestingStatus: 'ui-erm-usage.harvestingStatus',
          aggregator: 'ui-erm-usage.aggregator',
          latestStats: 'ui-erm-usage.latestStatistics'
        }}
